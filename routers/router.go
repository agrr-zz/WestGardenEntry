...
func init() {
	...
	beego.Router("/event", &controllers.MainController{}, "get:ShowEvent;post:AddEvent")

	beego.Router("/eventMember", &controllers.MainController{}, "get:ShowEventMember;post:AddMember")
